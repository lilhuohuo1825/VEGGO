  ...
  selectCustomer(user: any): void {
    ...
    if (!this.orderData.deliveryInfo.name) {
      this.orderData.deliveryInfo = {
        ...
        orderSource: this.orderData.deliveryInfo.orderSource || '',
        orderSourceLabel: this.orderData.deliveryInfo.orderSourceLabel || '',
        deliveryTimeText: this.orderData.deliveryInfo.deliveryTimeText || '',
        isRecurring: Boolean(this.orderData.deliveryInfo.isRecurring),
        recurringOrderName: this.orderData.deliveryInfo.recurringOrderName || '',
        recurringFrequency: this.orderData.deliveryInfo.recurringFrequency || '',
        occurrenceDate: this.orderData.deliveryInfo.occurrenceDate || '',
      };
    }
  }
