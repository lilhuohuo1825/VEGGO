...
public class HomeFragment extends Fragment {
    ...
    private void setupHeader() {
        ...
        View.OnClickListener openSearch = v -> startActivity(
                new Intent(requireContext(), com.veggo.app.presentation.search.SearchActivity.class));
        binding.layoutSearch.setOnClickListener(openSearch);
        binding.stickyHeader.layoutStickySearch.setOnClickListener(openSearch);
