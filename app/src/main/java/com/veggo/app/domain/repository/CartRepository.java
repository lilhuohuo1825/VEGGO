...
public interface CartRepository {
    ...
    Call<CartDto> updateItemQuantity(String customerId, String sku, int quantity, double selectedWeight);
    Call<CartDto> removeItem(String customerId, String sku, double selectedWeight);
