...
const userSchema = new mongoose.Schema(
  {
    ...
    CertificateGrantedAt: { type: Date, default: null },
    CertificateCarbonPointSnapshot: { type: Number, default: 0 },
    CertificateCarbonEmissionSnapshot: { type: Number, default: 0 },
